...
function $LocaleProvider(){
  this.$get = function() {
    return {
      ...
      DATETIME_FORMATS: {
        QUARTER:
            'Quarter 1,Quarter 2,Quarter 3,Quarter 4'.split(','),
        SHORTQUARTER:  'Q1,Q2,Q3,Q4'.split(','),
        MONTH:
...
function dateQuarterGetter(name, shortForm) {
    return function(date, formats) {
        var month = date.getMonth() + 1;
        var value = Math.ceil(month / 3)-1;
        var get = uppercase(shortForm ? ('SHORT' + name) : name);
...
var DATE_FORMATS = {
  QQQQ: dateQuarterGetter('Quarter'),
	QQ: dateQuarterGetter('Quarter', true),
