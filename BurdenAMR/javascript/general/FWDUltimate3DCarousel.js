...
(function (e) {
    var t = function (n, r) {
        ...
        this.setupMainContainers = function () {
            ...
            i.selector_do = new FWDU3DCarComboBoxSelector(i.arrowW, i.arrowH, i.arrowN_str, i.arrowS_str, i.selectorLabel_str, i.selectorBkColorN_str1, i.selectorBkColorS_str1, i.selectorBkColorN_str2, i.selectorBkColorS_str2, i.selectorTextColorN_str, i.selectorTextColorS_str, i.buttonHeight);
            ...
            for (var t = 0; t < i.totalButtons; t++) {
                ...
                e = new FWDU3DCarComboBoxButton(i.categories_ar[t], i.itemBkColorN_str1, i.itemBkColorS_str1, i.itemBkColorN_str2, i.itemBkColorS_str2, i.itemTextColorN_str, i.itemTextColorS_str, t, i.buttonHeight);
                i.buttons_ar[t] = e;
...
(function () {
    var e = function (t, n, r, i, s, o, u, a, f) {
        ...
        this.setSelectedState = function (e) {
            if (e) {
                FWDU3DCarModTweenMax.to(l.colorObj, .6, {
                    colorProps: {
...
(function () {
    var e = function (t, n, r, i, s, o, u, a, f, l, c, h) {
        ...
        this.setSelectedState = function (e) {
            if (e) {
                FWDU3DCarModTweenMax.to(p.colorObj, .6, {
                    colorProps: {
    ...
    var t = function (e) {
        ...
        this.parseProperties = function () {
            ...
            if (!n.propsObj.carouselDataListDivId) {
                e = "Coverflow data list id is not defined in FWDU3DCar3DCoverflow constructor function!";
            ...
            if (!n.propsObj.skinPath) {
                n.dispatchEvent(t.LOAD_ERROR, {
                    text: "Coverflow graphics skin path is not defined in FWDU3DCar3DCoverflow constructor function!"
                });
                return
            }
    ...
    var t = function (e, t, n, r) {
        ...
        this.setX = function (e) {
            ...
            if (i.hasTransform3d_bl) {
                i.screen.style[i.transform] = "translate3d(" + i.x + "px," + i.y + "px," + i.z + "px)" + " rotateX(" + i.angleX + "deg) rotateY(" + i.angleY + "deg) rotateZ(" + i.angleZ + "deg) scale3d(" + i.scale + ", " + i.scale + ", 1)"
            } else if (i.hasTransform2d_bl) {
...
(function (e) {
    var t = function (n) {
        ...
        var _agentString = navigator.userAgent.toString();
        ...
        this.show = function (e) {
            ...
            if (_agentString.toLowerCase().indexOf("msie 7") != -1) {
...
(function (e) {
    var t = function (n, r, i) {
        ...
        this.setHandler = function () {
            ...
            s.scrollbarHandlerTextDO.setInnerHTML("<span id='car3dSB'></span>");
...
(function (e) {
    var t = function (e, n, r) {
        ...
        this.setupScreen = function () {
            i.mainDO = new FWDU3DCarDisplayObject("div");
            i.addChild(i.mainDO);
    ...
    var t = function (n, r) {
        ...
        this.init = function () {
            ...
            if (i.data.controlsPos) {
                i.thumbsHolderDO.setY(Math.floor((i.stageHeight - i.data.prevButtonNImg.height) / 2 + i.controlsHeight + i.carYOffset))
            } else {
                i.thumbsHolderDO.setY(Math.floor((i.stageHeight - i.data.prevButtonNImg.height) / 2) + i.carYOffset)
            ...
            for (var e = 0; e < i.totalThumbs; e++) {
                ...
                if (e == i.curId) {
                    ...
                    if (i.isMobile && i.textHolderDO) {
                        ...
                        FWDU3DCarModTweenMax.to(i.textGradientDO, .6, {
                            alpha: 0,
                            delay: .2,
                            ease: Expo.easeOut
                        })
        ...
        this.onCenterImageLoadHandler = function () {
            ...
            i.centerImgDO.setScale2(i.centerImgDO.getWidth() / i.centerImgDO.screen.getBoundingClientRect().width);
        ...
        this.setupThumbOver = function () {
            i.thumbOverDO = new FWDU3DCarDisplayObject("div");
        ...
        this.update = function (e) {
            ...
            var n;
            if (i.data.controlsPos) {
                n = Math.floor((i.stageHeight - i.data.prevButtonNImg.height) / 2 + i.controlsHeight + i.carYOffset)
            } else {
                n = Math.floor((i.stageHeight - i.data.prevButtonNImg.height) / 2) + i.carYOffset
            }
...
(function (e) {
    ...
    t.isMobile = function () {
        ...
        for (i in e) {
            if (_agentString.toLowerCase().indexOf(e[i].toString().toLowerCase()) != -1) {
                return true
            }
        }
        return false
    ...
    t.isAndroid = function () {
        return _agentString.toLowerCase().indexOf("android".toLowerCase()) != -1
    } ();
    t.isChrome = function () {
        return _agentString.toLowerCase().indexOf("chrome") != -1
    } ();
    t.isSafari = function () {
        return _agentString.toLowerCase().indexOf("safari") != -1 && _agentString.toLowerCase().indexOf("chrome") == -1
    } ();
    t.isOpera = function () {
        return _agentString.toLowerCase().indexOf("opera") != -1 && _agentString.toLowerCase().indexOf("chrome") == -1
    } ();
    t.isFirefox = function () {
        return _agentString.toLowerCase().indexOf("firefox") != -1
    } ();
    t.isIE = function () {
        var e = _agentString.toLowerCase().indexOf("msie") != -1;
        return Boolean(e || document.documentElement.msRequestFullscreen)
    } ();
    t.isIEAndLessThen9 = function () {
        return _agentString.toLowerCase().indexOf("msie 7") != -1 || _agentString.toLowerCase().indexOf("msie 8") != -1
    } ();
    t.isIEAndLessThen10 = function () {
        return _agentString.toLowerCase().indexOf("msie 7") != -1 || _agentString.toLowerCase().indexOf("msie 8") != -1 || _agentString.toLowerCase().indexOf("msie 9") != -1
    } ();
    t.isIEAndMoreThen8 = function () {
        return t.isIE9 || t.isIE10 || t.isIE11
    } ();
    t.isIE7 = function () {
        return _agentString.toLowerCase().indexOf("msie 7") != -1
    } ();
    t.isIE8 = function () {
        return _agentString.toLowerCase().indexOf("msie 8") != -1
    } ();
    t.isIE9 = function () {
        return _agentString.toLowerCase().indexOf("msie 9") != -1
    } ();
    t.isIE10 = function () {
        return _agentString.toLowerCase().indexOf("msie 10") != -1
    } ();
    t.isIE11 = function () {
        var e = _agentString.toLowerCase().indexOf("msie") != -1;
        return Boolean(!e && document.documentElement.msRequestFullscreen)
    ...
    var t = function (n) {
        ...
        this.init = function () {
            ...
            if (!FWDU3DCarUtils.getChildById(r.propsObj.carouselHolderDivId)) {
                alert("FWDUltimate3DCarousel holder div is not found, please make sure that the div exists and the id is correct! " + r.propsObj.carouselHolderDivId);
                return
            }
        ...
        this.setupContextMenu = function () {
            r.customContextMenuDO = new FWDU3DCarContextMenu(r.mainDO, r.data.showContextMenu)
        };
