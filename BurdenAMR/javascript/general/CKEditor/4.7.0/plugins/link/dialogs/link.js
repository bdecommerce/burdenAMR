    ...
    CKEDITOR.dialog.add("link", function (c) {
        ...
        return {
            ...
            onOk: function () {
                ...
                var _fnConfigureLink = function (lnk, linkType) {

                    lnk.setAttributes({ "data-role": "none", "data-rel": "external", "target": "_blank" });

                    if (linkType === "anchor") {
                        lnk.addClass("EditorAnchorLink");
                    }
                    else {
                        lnk.removeClass("EditorAnchorLink");
                    }
                };
                ...
                if (this._.selectedElements.length) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        ...
                        _fnConfigureLink(d.startContainer, a.type);
                        _fnConfigureLink(d.endContainer, a.type);
