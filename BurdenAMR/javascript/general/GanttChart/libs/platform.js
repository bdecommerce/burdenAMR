...
function openBlackPopup(url,width,height,onCloseCallBack,iframeId){
  ...
  bdiv.append("<img src=\"" + util_url_getRelativeForCurrentPath + "style/general/GanttChart/closeBig.png\" style='cursor:pointer;position:absolute;right:-40px;top:30px;'>");
...
function createBlackPage(width,height,onCloseCallBack){
  ...
  //var img = $("<img src='" + util_url_getRelativeForCurrentPath + "style/general/GanttChart/closeBig.png' style='cursor:pointer;position:absolute;right:-40px;top:5px;' title='close'>");
  //bdiv.append(img);
  bdiv.append("<a style='padding-left:10px' href='javascript:void(0)' onclick='closeBG()'>X</a>");
