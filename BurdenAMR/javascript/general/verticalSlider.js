...
/*
 Revisions:
 20130530 - AV - Added data attribute of "data-cattr-highlight-type" with possible values of "horizontal" (default) or "vertical"
                 (only applicable if the "data-highlight" is set to true).                 
*/
...
(function ($, undefined) {
    ...
    $.widget("mobile.slider", $.mobile.widget, {
        ...
        refresh: function (val, isfromControl, preventInputUpdate) {
            ...
            //AV-20130530
            var _attrHighlightType = control.attr("data-cattr-highlight-type");
            var _highlightType = (_attrHighlightType != undefined && _attrHighlightType == "vertical" ? "vertical" : "horizontal");

            this.valuebg && this.valuebg.css((_highlightType == "horizontal" ? "width" : "height"), percent + "%");
